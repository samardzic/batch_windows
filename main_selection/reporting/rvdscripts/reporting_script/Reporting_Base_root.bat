...
:: ------ Calls a function that merges the JSON files into a single JSON file
call npx mochawesome-report-generator %reports_location%\%packageName%_mergedReports.json -f %packageName%_report -t RVD_%packageName%_report -o %reports_location%\ --inline=true
