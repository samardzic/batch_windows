...
set SCRIPT_PATH="c:\rvd\integration"
...
REM call %GRADLE_PATH%/gradle test --tests testCases.BindingTest.BindingTest
REM call %GRADLE_PATH%/gradle test -DvehicleToy=WVDansPassat --tests *testCases.firmware.FirmwareTest
call %GRADLE_PATH%/gradle test -D vehicleToy=WVDansPassat --tests *testCases.binding.Binding_12744373*
REM call %GRADLE_PATH%/gradle test -DvehicleToy=WVDansPassat --tests *testCases.binding.Binding_12744892*
REM call %GRADLE_PATH%/gradle test -DvehicleToy=WVDansPassat --tests *testCases.binding.BindingTest
