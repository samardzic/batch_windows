# Cypress & Appium integration

This is the howto document intended to guide you through Cypres -> Appium integration process.

## Install Appium through Command line
```	
npm install -g appium@1.13
```

Start the appium server from CLI:
```
appium --port 4745
or
appium --address <Machine IP> --port <port> --udid <UDID>
appium -a <Machine IP> -p <port> -U <UDID>
```

get the list of available appium options:
```
appium --help

λ appium --help
usage: C:\Users\uia66114\AppData\Roaming\npm\node_modules\appium\build\lib\main.js
...
Optional arguments:
  ...
  -pa BASEPATH, --base-path BASEPATH
                        ...
                        routes runningon this server (default: /wd/hub)
  ...
  --automation-name AUTOMATIONNAME
                        [DEPRECATED] - Name of the automation tool: Appium,
                        XCUITest, etc.
  ...
  --async-trace         [DEPRECATED] - Add long stack traces to log entries.
                        Recommended for debugging only.
                        

```

run appium with "relaxed-security" enabled:
```
appium -p 4745 --relaxed-security
```