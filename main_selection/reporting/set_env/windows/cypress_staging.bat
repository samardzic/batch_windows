...
set test_data_staging=cypress\test_data\staging
...
xcopy %root_path%\%cypress_location%\%test_data_staging%\test_data_staging.js %root_path%\%cypress_location%\%test_data_active%

:: Renames STAGING test data file to ACTIVE test data file, and sets it as ACTIVE test data file
rename %root_path%\%cypress_location%\%test_data_active%\test_data_staging.js testData.active.js
