...
echo "Setting power scheme %power_saver% to active mode for computer: %computername%"
powercfg /setactive %power_saver%
echo/

echo.
echo "Changing power configuration settings for power scheme: %power_saver% on Computer: %computername%"
