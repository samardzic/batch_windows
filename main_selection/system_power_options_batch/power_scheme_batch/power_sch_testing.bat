...
echo "Setting power scheme %testing% to active mode for computer: %computername%"
powercfg /setactive %testing%
echo/

echo.
echo "Changing power configuration settings for power scheme: %testing% on Computer: %computername%"
