...
echo "Setting power scheme %high_performance% to active mode for computer: %computername%"
powercfg /setactive %high_performance%
echo/

echo.
echo "Changing power configuration settings for power scheme: %high_performance% on Computer: %computername%"
