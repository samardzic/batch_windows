...
set COMMANDS=sandbox allow-same-origin allow-scripts; default-src 'self'; \+\
'unsafe-inline' 'unsafe-eval'; script-src 'self' 'unsafe-inline';

:: set HUDSON_CSP_V3=-Xrs -Xms4096m -Xmx4096m -Dhudson.model.DirectoryBrowserSupport.CSP=%COMMANDS%
:: -Dhudson.model.DirectoryBrowserSupport.CSP="sandbox allow-same-origin allow-scripts; default-src 'self' 'unsafe-inline' 'unsafe-eval';"
